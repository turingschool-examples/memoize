const javascripty = [
  {
    ...
    "correctAnswer": "They act as a containers for values that can later be reused."
  }, 

  {
    ...
    "correctAnswer": "No, once you assign a specific literal type to a variable, you can later reassign the variable to host any other type, without type errors or any issue." 
  }, 
  {
    "id": 2, 
    "category": "variables", 
    ...
    "correctAnswer": "A variable must be declared with var, let, or const before it can be used."
  },
  {
    "id": 3, 
    "category": "functions", 
    ...
    "correctAnswer": "A function is a block of code, self contained, that can be defined once and run any number of times you want." 
  },
  {
    "id": 4, 
    "category": "functions", 
  ...
  },
  {
    ...
    "correctAnswer": "Values are returned without having to use the keyword return."
  },
  {
    "id": 6, 
    ...
    "correctAnswer": "A conditional statement checks specific condition(s) and performs a task based on the condition(s)." 
  },
  {
    "id": 7, 
    "category": "conditionals", 
    ...
    "correctAnswer": "All values are truthy unless they are defined as falsy."
  },
  {
    "id": 8, 
    "category": "conditionals", 
    ...
    "correctAnswer": "When an if statement encounters a falsy value that goes against our condition will be bypassed." 
  },
  {
    "id": 9, 
    ...
    "correctAnswer": "Because they are mutable and all complex data types are objects with methods."
  },
  {
    "id": 10, 
    "category": "complex data types", 
    ...
    "correctAnswer": "When we create a variable and assign it to a pre-existing object, that variable will refer to that object in memory." 
  },
  {
    "id": 11, 
    "category": "complex data types", 
    ...
    "correctAnswer": "Arrays, Dates, Objects, JSON" 
  },
  {
    "id": 12, 
    ...
    "correctAnswer": " Strings, Numbers, Booleans, Null, Undefined"
  }, 
  {
    "id": 13, 
    "category": "primitive data types", 
  ...
  },
  {
    ...
    "correctAnswer": "All primitives are immutable, a variable can be reassigned a new value, but the existing value can not be changed."
  },
  {
    "id": 15, 
    "category": "scope", 
    ...
    "correctAnswer": "The environment where a variable can be accessed."
  },
  {
    "id": 16, 
    "category": "scope", 
    ...
    "correctAnswer": "Global, Function, Block"
  },
  {
    "id": 17, 
    "category": "scope", 
    ...
    "correctAnswer": "Every line of code has a scope associated to it, our interpreter will traverse up parent scope until it finds the variable declaration."
  },
  {
    "id": 18, 
    "category": "this", 
    ...
    "correctAnswer": "This will always refer to the current line of code that is executing by default."
  },
  {
    "id": 19,  
    "category": "this", 
    ...
    "correctAnswer": "This refers to the current context or owner of code being executed." 
  },
  {
    "id": 20, 
    "category": "classes", 
  ...
  },
  {
    ...
    "correctAnswer": "A blueprint of an object that provides what information it should contain and how it should interact with data." 
  },
  {
    "id": 22, 
    "category": "classes", 
  ...
  },
  {
    ...
    "correctAnswer": "Every single JavaScript object has a property, called prototype, which points to a different object."
  },
  {
    "id": 24, 
    "category": "prototypal inheritance", 
    ...
    "correctAnswer": "Without built in methods we would not be able to manipulate data."
  },
  {
    "id": 25, 
    ...
    "correctAnswer": "Parameters act as placeholders for values that will be needed for a function, and arguments are real values passed into functions that take parameters."
  },
  {
    "id": 26, 
    "category": "parameters vs. arguments", 
    ...
    "correctAnswer": "Primitives or Objects can be passed into an object."
  },
  {
    "id": 27, 
    ...
    "correctAnswer": "Dot is typically default, but recognize when to use bracket."
  },
  {
    "id": 28, 
    "category": "dot notation vs bracket notation" , 
    ...
    "correctAnswer": "Bracket Notation is great for creating dynamic ket value pairs."
  },
  {
    "id": 29, 
    ...
    "correctAnswer": "Creating and infinite loop or synchronous network calls."
  }
]; 

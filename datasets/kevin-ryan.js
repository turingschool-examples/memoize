const usefulJavascript = [
...

  {
    "name": "filter",
    "type": "iterator",
    "question": "filter() returns an array of the exact same length",
    "answer1": "True",
    "answer2": "False",
...

  {
    "name": "map",
    "type": "iterator",
    "question": "Complete this sentance: map() is an _____ method",
    "answer1": "iterator",
    "answer2": "mutator",
    "answer3": "accessor",
...

  {
    "name": "forEach",
    "type": "iterator",
    "question": "forEach() returns a subset of the original array",
    "answer1": "True",
    "answer2": "False",
...

  {
    ...
    "answer2": "Nothing",
    "answer3": "The first value that evaluates to true in the callback statement",
...

  {
    "name": "Object.assign",
    "type": "object prototype",
    "question": "Object.assign() allows you to copy contents of two or more objects into a new object",
    "answer1": "False",
    "answer2": "True",
...

  {
    ...
    "answer2": "change the order of an array making the first element last and the last element first",
    "answer3": "iterate through an array from the last element to the first",
...

  {
    ...
    "type": "mutator",
    "question": "sort()",
    "answer1": "orders the elements in array and returns the new array",
...

  {
    ...
    "type": "operator",
    "question": "this",
    "answer1": "the use of this is the same in both ES5 and ES6",

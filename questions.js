const questions = [
  ...
  }, 
  {
    ...
    answers: ["Hoisting allows us to use variables before they are declared.", "Variables can be used whenever our code is being executed.", "A variable must be delcared with var, let, or const before it can be used."],  
    correct-answer: "A variable must be delcared with var, let, or const before it can be used.", 
  },
  {
    id: 3, 
    category: "functions", 
  ...
  {
    id: 6, 
    category: "conditonals", 
    question: "What does a conditional statment in accomplish?", 
    answers: ["Allows us to merge lines of code.", "Makes a condtional line of code.", "A conditional statement checks specific condition(s) and performs a task based on the condition(s)."],
  ...
  {
    id: 8, 
    category: "condtionals", 
    question: "Will an "if" statement be bypassed are coerced to false in Boolean contexts?", 
    answers: ["False, our code with execute using instructions between an if statements curly braces.", "When an if statment encourters a falsy value that goes against our condition will be bypassed.", "All values in a conditional are truthy."], 
    correct-answer: "When an if statment encourters a falsy value that goes against our condition will be bypassed." 
  },
  {
    id: 9, 
  ...
  },
  {
    id: 13, 
    category: "primitive data types", 
    question: "Which primitive values do not have object equivalent wrappers that wrap thier value?", 
  ...
  },
  {
    id: 14, 
    category: "primitive data types", 
    question: "Are primitive data types immmutable?", 
  ...
  },
  {
    ...
    answers: ["An object that inherits from a parent class.", ", "A blueprint of an object that provides what information it should contain and how it should interact with data."],
  ...
  },
  {
    id: 22, 
    category: "classes", 
    question: "What method must we use to invoke a classes contructor method?", 
  ...
  },
  {
    ...
    answers: ["Protypes help invoke functions.", "Every single JavaScript object has a property, called prototype, which points to a different object.", "Our objects inherit properties and methods from other function definitions."], 
  ...
  },
  {
    id: 26, 
    category: "parameters vs. arguments", 
    question: "Can objects be passed into a funtion as an object?", 
  ...
  },
  {
    ...
    answers: ["Creating and infinite loop or synchronous network calls.", "Unsing an anonymous function.", "Reassigning a variable in block scope."], 
